...
So what's a good, performance-minded full stack developer to do? How can we take our page loads from slow to ludicrous speed? {% marginnote "<img src='http://i.imgur.com/F3y7xvo.gif'></img><br>" %}
