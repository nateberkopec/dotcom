...
* **There is no "good" latent space.**{% sidenote 5 "<img class='fullwidth' src='/assets/img/posts/good-latent-space-2026.png' alt='Latent space screenshot'>" %} You can't prompt an LLM out of the "average coder" space into the "coding like Dijkstra" space. Role-based prompting ("you are an expert in...") doesn't work because there's not some secret part of the latent space which contains the superintelligence we've all been looking for.
