...
It's 12pm on a Monday. Your boss walks by: "The site feels...slow. I don't know, it just does." Hmmm. You riposte with the classic developer reply: "Well, it's fast on my local machine." Boom! Boss averted! {% marginnote "<img src='http://i.imgur.com/D20c1vk.gif'></img>" %}
...
{% marginnote "<img src='http://i.imgur.com/vmp1svR.gif'></img>" %}I can hear the keyboards clattering already furiously emailing me: "That's so slow! Rails sucks! Blah blah..."
