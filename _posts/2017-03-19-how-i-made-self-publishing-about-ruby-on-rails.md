...
{% marginfigure /assets/img/posts/mongodb.png %}
...
{% marginfigure /assets/img/posts/turbolinks.png %}
...
**Refunds** are not a problem. In hundreds of sales, I've only had 2 refunds. Offer as many money-back, 100% satisfaction guarantees as you can on the selling page, because they provide far more benefit than cost.
