...
* If you're specifying `X-UA-Compatible` and the value is just "IE=edge", [that's unnecessary](http://stackoverflow.com/questions/26346917/why-use-x-ua-compatible-ie-edge-anymore). Remove it. {% marginnote "<img src='http://i.imgur.com/XfG2mTw.gif'></img><br><i>Internet Explorer's reaction to IE=edge</i>" %}
